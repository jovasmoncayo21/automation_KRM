...
public class AgregarIngresos extends Main {
    ...
    public static void agregaIngreso() throws InterruptedException{
        ...
        /*Flujo alterno para eliminar un ingreso
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(Objetos.BtnEliminarIng)));
        Thread.sleep(2000);
        driver.findElement(By.xpath(Objetos.BtnEliminarIng)).click();
        //Thread.sleep(2000);
        //driver.findElement(By.xpath(Objetos.btnCancelarIng)).click();
        Thread.sleep(2000);
        //El elemento no es interactuable por lo que no puedo confirmar la eliminacion
        driver.findElement(By.xpath(Objetos.btnConfirmarIng)).click();*/
